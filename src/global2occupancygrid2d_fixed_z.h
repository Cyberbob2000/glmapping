#ifndef GLOBAL2OCCUPANCYGRID2DFZ_H
#define GLOBAL2OCCUPANCYGRID2DFZ_H
...
class Global2OccupancyGrid2DFZ
{
    int map2d_nx;
    int map2d_ny;
    double map2d_dx;
...
public:
    ...
    Global2OccupancyGrid2DFZ(ros::NodeHandle& nh, string topic_name, int buffersize=2);
